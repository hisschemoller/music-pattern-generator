...
const ADD_PROCESSOR = 'ADD_PROCESSOR',
  ...
  SET_TRANSPORT = 'SET_TRANSPORT',
	START_PROCESSOR_INTERACTION = 'START_PROCESSOR_INTERACTION',
...
export default {
  ...
  importProject: file => {
	...
	START_PROCESSOR_INTERACTION,
	startProcessorInteraction: (name) => ({ type: START_PROCESSOR_INTERACTION, name }),
